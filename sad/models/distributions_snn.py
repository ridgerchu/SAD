...
from sad.layers.convolutions import SpikingBottleneck
...
class DistributionEncoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.model = nn.Sequential(
            SpikingBottleneck(in_channels, out_channels=out_channels, downsample=True),
            SpikingBottleneck(out_channels, out_channels=out_channels, downsample=True),
            SpikingBottleneck(out_channels, out_channels=out_channels, downsample=True),
            SpikingBottleneck(out_channels, out_channels=out_channels, downsample=True),
        )
